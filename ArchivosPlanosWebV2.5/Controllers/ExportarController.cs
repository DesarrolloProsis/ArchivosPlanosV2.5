...
namespace ArchivosPlanosWebV2._5.Controllers
{
    public class ExportarController : Controller
    {
        ...
        public ActionResult Index(ControlesExportar model)
        {
            ...
            try
            {
...

                {
                    ...
                    archivo1A.Generar_Bitacora_Operacion(Turno.Text, FechaInicio, Convert.ToString(Plaza.Value), Convert.ToString(Delegacion.Value), "01", ConexionDB);
                    archivo2A.Preliquidaciones_de_cajero_receptor_para_transito_vehicular(Turno.Text, FechaInicio, Convert.ToString(Plaza.Value), Convert.ToString(Delegacion.Value), "01", ConexionDB);
                    archivo9A.eventos_detectados_y_marcados_en_el_ECT(Turno.Text, FechaInicio, Convert.ToString(Plaza.Value), Convert.ToString(Delegacion.Value), "01", ConexionDB);
                    archivoII.Registro_usuarios_telepeaje(Turno.Text, FechaInicio, Convert.ToString(Plaza.Value), Convert.ToString(Delegacion.Value), "01", ConexionDB);
                    archivoPA.eventos_detectados_y_marcados_en_el_ECT_EAP(Turno.Text, FechaInicio, Convert.ToString(Plaza.Value), Convert.ToString(Delegacion.Value), "01", ConexionDB);
        ...
        public JsonResult GetDelegaciones()
        {
            ...
            {
                if (indi["Nom_Delegacion"].ToString() == "Coordinación Regional No. 6 Cuernavaca")
                {
        ...
        public JsonResult GetPlazaCobro()
        {
            ...
            {
                string numpla;
                if (indi["Num_Plaza"].ToString() == "81" || indi["Num_Plaza"].ToString() == "81" || indi["Num_Plaza"].ToString() == "81")
